...
messageAction("vendor - " + Project.name);
...
if (Shell.getFileSize("archive/" + Project.vendor + ".7z") > 16000) {
	return;
};
Shell.removeFile("archive/" + Project.vendor + ".7z");
...
runInPath("archive", function() {
	webLink = "https://github.com/Richard9394/MingCute/archive/refs/tags/v" + Project.version + ".zip";
	...
	Shell.rename("MingCute-"+Project.version,Project.vendor);
